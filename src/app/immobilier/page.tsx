    ...
    <main style={{ fontFamily: "system-ui, -apple-system, sans-serif", background: C.gris, minHeight: "100vh" }}>
        ...
        <div style={{ maxWidth: "1100px", margin: "0 auto", display: "flex", alignItems: "center", justifyContent: "space-between", height: isMobile ? "60px" : "72px" }}>
          ...
          {!isMobile && (
            <div style={{ display: "flex", gap: isTablet ? "16px" : "24px", alignItems: "center" }}>
              {[{ label: "Notre selection", href: "#selection" }, { label: "Par region", href: "#regions" }, { label: "Simulateur", href: "/simulateur" }].map(l => (
        ...
        <div style={{ maxWidth: "1100px", margin: "0 auto" }}>
          <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", gap: "32px", flexWrap: "wrap" }}>
            <div style={{ maxWidth: "560px" }}>
              ...
              <p style={{ color: C.texteSec, fontSize: isMobile ? "14px" : "15px", lineHeight: 1.8, margin: "0 0 24px" }}>
                Villas touristiques, locaux commerciaux, appartements. Investissez des 100 euros et percevez des revenus locatifs chaque trimestre, sans aucune gestion.
              </p>
              <div style={{ display: "flex", gap: "10px", flexWrap: "wrap" }}>
                <Link href="#selection" style={{ background: C.turquoise, color: "white", padding: "11px 20px", borderRadius: "8px", fontSize: "13px", fontWeight: 600, textDecoration: "none" }}>
                  Voir les biens
                </Link>
                <Link href="/simulateur" style={{ background: "white", color: C.turquoise, border: `1.5px solid ${C.turquoise}`, padding: "11px 20px", borderRadius: "8px", fontSize: "13px", fontWeight: 600, textDecoration: "none" }}>
                  Simuler mon rendement
                </Link>
              </div>
            </div>
            {/* Métriques — masquées sur mobile */}
            {!isMobile && (
      ...
      <section style={{ padding: isMobile ? "40px 16px" : "64px 24px", background: "white", borderBottom: `0.5px solid ${C.grisBord}` }}>
        <div style={{ maxWidth: "1100px", margin: "0 auto" }}>
          <div style={{ marginBottom: "20px" }}>
            ...
            <h2 style={{ color: C.texte, fontSize: isMobile ? "20px" : "26px", fontWeight: 800, margin: "0 0 6px" }}>Nos biens a travers la Caraibe</h2>
            {!isMobile && <p style={{ color: C.texteSec, fontSize: "13px", margin: 0 }}>Zoomez sur la carte et cliquez sur un marqueur pour voir les details.</p>}
          </div>
          ...
          <div style={{ display: "flex", gap: "16px", marginTop: "10px" }}>
            <div style={{ display: "flex", alignItems: "center", gap: "6px", fontSize: "11px", color: C.texteSec }}>
              <div style={{ width: "10px", height: "10px", borderRadius: "50%", background: C.turquoise }} />Biens disponibles
            </div>
            <div style={{ display: "flex", alignItems: "center", gap: "6px", fontSize: "11px", color: C.texteSec }}>
              <div style={{ width: "10px", height: "10px", borderRadius: "50%", background: "#9CA3AF" }} />Complet
            </div>
          </div>
        </div>
      </section>
      ...
      <section id="regions" style={{ padding: isMobile ? "40px 16px" : "64px 24px" }}>
        <div style={{ maxWidth: "1100px", margin: "0 auto" }}>
          <div style={{ marginBottom: "28px" }}>
            ...
            <h2 style={{ color: C.texte, fontSize: isMobile ? "20px" : "26px", fontWeight: 800, margin: 0 }}>Par region</h2>
          </div>
            ...
            {REGIONS.map((r, i) => (
              ...
              >
                <div style={{ background: r.couleur, padding: "14px 20px", display: "flex", justifyContent: "space-between", alignItems: "flex-start", position: "relative", overflow: "hidden", minHeight: "70px" }}>
                  <div style={{ position: "absolute", left: 0, top: 0, bottom: 0, width: "35%", overflow: "hidden" }}>
                    <div style={{ position: "relative", width: "100%", height: "100%" }}>
                      <Image
                        src={r.nom === "Guadeloupe" ? "/images/carte-guadeloupe.jpg" : r.nom === "Martinique" ? "/images/carte-martinique.jpg" : r.nom === "Guyane" ? "/images/carte-guyane.jpg" : "/images/carte-saintmartin.jpg"}
                        alt={r.nom} fill sizes="200px" style={{ objectFit: "cover", opacity: .35 }}
                      />
                    </div>
                  ...
                  <div style={{ textAlign: "right", position: "relative", zIndex: 1 }}>
                    <div style={{ color: "rgba(255,255,255,.9)", fontSize: "10px", marginBottom: "2px" }}>Rendement moyen</div>
                ...
                <div style={{ padding: "12px 20px", display: "grid", gridTemplateColumns: "repeat(3, 1fr)", gap: "10px", borderBottom: "0.5px solid #E5E7EB" }}>
                  {[{ label: "Population", val: r.population }, { label: "Prix m2", val: r.prixM2Moyen }, { label: "Touristes/an", val: r.touristes }].map((m, j) => (
                    <div key={j}>
                ...
                {regionActive === r.nom ? (
                  ...
                  <div style={{ padding: "10px 20px", color: C.turquoise, fontSize: "11px", fontWeight: 600 }}>Voir le contexte economique →</div>
                )}
              </div>
            ))}
          </div>
          <div style={{ marginTop: "14px", padding: "14px 20px", background: "white", borderRadius: "12px", border: `0.5px solid ${C.grisBord}`, display: "flex", justifyContent: "space-between", alignItems: "center", flexWrap: "wrap", gap: "10px" }}>
            <div>
              <div style={{ color: C.texte, fontSize: "13px", fontWeight: 600, marginBottom: "2px" }}>Expansion Caraibe anglophone et hispanophone</div>
              <div style={{ color: C.texteSec, fontSize: "12px" }}>Jamaique, Trinidad, Barbade — lancement prevu 2027</div>
            </div>
            <span style={{ background: "#E6F1FB", color: "#0C447C", fontSize: "10px", fontWeight: 700, padding: "3px 10px", borderRadius: "20px", whiteSpace: "nowrap" }}>Bientot disponible</span>
          </div>
        </div>
      </section>
      ...
      <section style={{ background: C.navy, padding: isMobile ? "40px 16px" : "64px 24px" }}>
        <div style={{ maxWidth: "1100px", margin: "0 auto" }}>
          <div style={{ textAlign: "center", marginBottom: "36px" }}>
            ...
            <h2 style={{ color: "white", fontSize: isMobile ? "20px" : "26px", fontWeight: 800, margin: 0 }}>De la selection du bien a votre premier revenu</h2>
          </div>
      ...
      <section style={{ padding: isMobile ? "40px 16px" : "64px 24px", background: "white", borderBottom: `0.5px solid ${C.grisBord}` }}>
        <div style={{ maxWidth: "1100px", margin: "0 auto" }}>
          <div style={{ marginBottom: "28px" }}>
            ...
            <h2 style={{ color: C.texte, fontSize: isMobile ? "20px" : "26px", fontWeight: 800, margin: "0 0 6px" }}>4 strategies locatives</h2>
            {!isMobile && <p style={{ color: C.texteSec, fontSize: "13px", margin: 0 }}>Cliquez sur une strategie pour voir les biens correspondants.</p>}
          </div>
          <div style={{ display: "grid", gridTemplateColumns: isMobile ? "repeat(2, 1fr)" : "repeat(4, 1fr)", gap: "12px" }}>
            {TYPES_BAIL.map((t, i) => (
              <div key={i}
                onClick={() => handleBailFilter(t.nom)}
                style={{ background: C.gris, borderRadius: "10px", padding: isMobile ? "14px" : "20px", borderTop: `3px solid ${t.couleur}`, borderRight: `0.5px solid ${C.grisBord}`, borderBottom: `0.5px solid ${C.grisBord}`, borderLeft: `0.5px solid ${C.grisBord}`, cursor: "pointer", transition: "all .2s" }}
              >
                <div style={{ fontSize: "22px", marginBottom: "8px" }}>{t.icone}</div>
                <div style={{ color: C.texte, fontSize: "12px", fontWeight: 700, marginBottom: "4px" }}>{t.nom}</div>
                <div style={{ color: t.couleur, fontSize: isMobile ? "16px" : "18px", fontWeight: 800, marginBottom: "4px" }}>{t.rendement}</div>
                {!isMobile && <div style={{ color: C.texteTert, fontSize: "10px", marginBottom: "8px" }}>Risque : {t.risque}</div>}
                {!isMobile && <div style={{ color: C.texteSec, fontSize: "11px", lineHeight: 1.6, marginBottom: "10px" }}>{t.description}</div>}
      ...
      <section style={{ padding: isMobile ? "40px 16px" : "64px 24px", background: C.gris }}>
        <div style={{ maxWidth: "1100px", margin: "0 auto" }}>
          <div style={{ marginBottom: "28px" }}>
            ...
            <h2 style={{ color: C.texte, fontSize: isMobile ? "20px" : "26px", fontWeight: 800, margin: "0 0 6px" }}>Defiscalisation et optimisation</h2>
            {!isMobile && <p style={{ color: C.texteSec, fontSize: "13px", margin: 0 }}>Les DOM offrent des dispositifs de defiscalisation parmi les plus avantageux de France.</p>}
          </div>
          <div style={{ display: "grid", gridTemplateColumns: isMobile ? "1fr" : "repeat(2, 1fr)", gap: "14px" }}>
            {FISCALITE.map((f, i) => (
        ...
        <div style={{ maxWidth: "1100px", margin: "0 auto" }}>
          <div style={{ display: "flex", justifyContent: "space-between", alignItems: "flex-start", marginBottom: "20px", flexWrap: "wrap", gap: "12px" }}>
            <div>
              ...
              <h2 style={{ color: C.texte, fontSize: isMobile ? "20px" : "26px", fontWeight: 800, margin: 0 }}>
                {filtreType === "tous" && filtreRegion === "toutes" ? "Tous les biens disponibles" : `Biens ${filtreRegion !== "toutes" ? `en ${filtreRegion}` : ""}`}
              </h2>
            </div>
          </div>
          ...
          <div style={{ display: "flex", flexDirection: "column", gap: "10px", marginBottom: "18px" }}>
            <div style={{ display: "flex", gap: "6px", flexWrap: "wrap", alignItems: "center" }}>
              <span style={{ color: C.texteTert, fontSize: "11px", fontWeight: 600, minWidth: "50px" }}>Type :</span>
              {[{ key: "tous", label: "Tous" }, { key: "villa", label: "Villas" }, { key: "hotel", label: "Hotels" }, { key: "commercial", label: "Commercial" }, { key: "meuble", label: "Meuble" }].map(f => (
                <button key={f.key} onClick={() => setFiltreType(f.key as typeof filtreType)} style={{ padding: "5px 12px", borderRadius: "20px", cursor: "pointer", fontSize: "11px", fontWeight: 600, border: filtreType === f.key ? `1.5px solid ${C.turquoise}` : `0.5px solid ${C.grisBord}`, background: filtreType === f.key ? C.turqLight : "white", color: filtreType === f.key ? C.turqDark : C.texteSec, transition: "all .15s" }}>{f.label}</button>
              ))}
            </div>
            <div style={{ display: "flex", gap: "6px", flexWrap: "wrap", alignItems: "center" }}>
              <span style={{ color: C.texteTert, fontSize: "11px", fontWeight: 600, minWidth: "50px" }}>Region :</span>
              {[{ key: "toutes", label: "Toutes" }, { key: "Guadeloupe", label: "Guadeloupe" }, { key: "Martinique", label: "Martinique" }, { key: "Guyane", label: "Guyane" }, { key: "Saint-Martin", label: "St-Martin" }].map(f => (
                <button key={f.key} onClick={() => setFiltreRegion(f.key as typeof filtreRegion)} style={{ padding: "5px 12px", borderRadius: "20px", cursor: "pointer", fontSize: "11px", fontWeight: 600, border: filtreRegion === f.key ? `1.5px solid ${C.turquoise}` : `0.5px solid ${C.grisBord}`, background: filtreRegion === f.key ? C.turqLight : "white", color: filtreRegion === f.key ? C.turqDark : C.texteSec, transition: "all .15s" }}>{f.label}</button>
              ))}
            </div>
          ...
          <div style={{ color: C.texteSec, fontSize: "12px", marginBottom: "16px" }}>
            {biensFiltres.length} bien{biensFiltres.length > 1 ? "s" : ""} disponible{biensFiltres.length > 1 ? "s" : ""}
          </div>
          ...
          <div style={{ display: "grid", gridTemplateColumns: colsBiens, gap: "14px" }}>
            {biensFiltres.map(bien => {
              ...
              return (
                <Link key={bien.id} href={`/immobilier/${getBienSlug(bien)}`} style={{ textDecoration: "none", display: "block" }}
                  ...
                  <div style={{ background: "white", borderRadius: "12px", overflow: "hidden", border: hovered === bien.id ? `1.5px solid ${C.turquoise}` : `0.5px solid ${C.grisBord}`, transition: "all .2s", opacity: complet ? .65 : 1, transform: hovered === bien.id && !complet ? "translateY(-3px)" : "none", boxShadow: hovered === bien.id && !complet ? "0 8px 24px rgba(8,145,178,.1)" : "none" }}>
                    ...
                    <div style={{ padding: "12px 14px" }}>
                      ...
                      <div style={{ display: "grid", gridTemplateColumns: "repeat(3, 1fr)", gap: "6px", marginBottom: "8px" }}>
                        {[{ label: "Rdt brut", val: bien.rendementBrut }, { label: "Occupation", val: bien.occupation }, { label: "Token", val: `${bien.prixToken}€` }].map(m => (
      ...
      <section style={{ background: C.turquoise, padding: isMobile ? "48px 16px" : "72px 24px", textAlign: "center" }}>
        <div style={{ maxWidth: "580px", margin: "0 auto" }}>
          ...
          <h2 style={{ color: "white", fontSize: isMobile ? "22px" : "28px", fontWeight: 800, lineHeight: 1.2, margin: "0 0 12px" }}>
            Rejoignez la famille CaribbeanVault
          </h2>
          <p style={{ color: "rgba(255,255,255,.85)", fontSize: "14px", lineHeight: 1.8, margin: "0 0 24px" }}>
            Soyez alerte en avant-premiere des nouveaux biens et rejoignez une communaute d'investisseurs passionnes par la Caraibe.
          </p>
          <Link href="/kyc" style={{ display: "inline-block", background: "white", color: C.turqDark, padding: "14px 32px", borderRadius: "8px", fontSize: "13px", fontWeight: 700, textDecoration: "none" }}>
            Rejoindre la famille CaribbeanVault
          </Link>
          <p style={{ color: "rgba(255,255,255,.5)", fontSize: "11px", marginTop: "12px" }}>{"Gratuit - Sans engagement"}</p>
        </div>
      </section>
