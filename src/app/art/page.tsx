...
const OEUVRES = [
  { id: 1, slug: "femme-aux-flamboyants", titre: "Femme aux Flamboyants", artiste: "Marie-Helene Caumont", origine: "Martinique", annee: 2023, medium: "Huile sur toile 120x90 cm", estimation: 8500, tokens: 85, disponibles: 31, prixToken: 100, royaltes: "5%", statut: "En levee", style: "Neo-creole expressionniste", couleurs: ["#C8192A", "#F5A623", "#1A6B5A", "#F0E6D2"], tag: "Martinique", territoire: "martinique" },
  { id: 2, slug: "memoire-de-saint-domingue", titre: "Memoire de Saint-Domingue", artiste: "Jean-Claude Fortune", origine: "Haiti", annee: 2022, medium: "Acrylique sur toile 150x120 cm", estimation: 14000, tokens: 140, disponibles: 8, prixToken: 100, royaltes: "5%", statut: "Dernieres places", style: "Art haitien contemporain", couleurs: ["#1A3A8A", "#C8992A", "#8B1A1A", "#F5E8C0"], tag: "Haiti", territoire: "haiti" },
  { id: 3, slug: "foret-amazonienne-3", titre: "Foret Amazonienne 3", artiste: "Kali Maloum", origine: "Guyane francaise", annee: 2024, medium: "Techniques mixtes 200x140 cm", estimation: 11000, tokens: 110, disponibles: 110, prixToken: 100, royaltes: "5%", statut: "Nouveau", style: "Art contemporain guyanais", couleurs: ["#0D4A1A", "#5A8A3C", "#D4C07A", "#1A3D2E"], tag: "Guyane", territoire: "diaspora" },
  { id: 4, slug: "bele-nocturne", titre: "Bele Nocturne", artiste: "David Sejour", origine: "Guadeloupe", annee: 2023, medium: "Huile et or sur toile 100x80 cm", estimation: 6200, tokens: 62, disponibles: 0, prixToken: 100, royaltes: "5%", statut: "Complet", style: "Abstraction caribeenne", couleurs: ["#0A0A1A", "#C8992A", "#4A2A6A", "#E8E0F0"], tag: "Guadeloupe", territoire: "guadeloupe" },
  { id: 5, slug: "marche-de-jacmel", titre: "Marche de Jacmel", artiste: "Roseline Augustin", origine: "Haiti", annee: 2021, medium: "Huile sur toile 180x130 cm", estimation: 22000, tokens: 220, disponibles: 44, prixToken: 100, royaltes: "5%", statut: "En levee", style: "Realisme naif haitien", couleurs: ["#E83A2A", "#F5A020", "#2A8A3A", "#4A2ACA"], tag: "Haiti Millesime", territoire: "haiti" },
  { id: 6, slug: "droits-musicaux-kase-ko", titre:"Droits Musicaux - Kase Ko", artiste: "Collectif Zouk Numerique", origine: "Martinique & Guadeloupe", annee: 2024, medium: "Catalogue 12 titres Droits numeriques", estimation: 35000, tokens: 350, disponibles: 180, prixToken: 100, royaltes: "8%", statut: "En levee", style: "Droits musicaux Zouk", couleurs: ["#7B2FBE", "#E8B86D", "#1A0A2E", "#F5E8C0"], tag: "Droits musicaux", territoire: "diaspora" },
];
